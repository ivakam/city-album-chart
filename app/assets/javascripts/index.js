    ...
    if ($("body").hasClass("albums index")) {
      ...
      toggleAlbum = function(title, sibling, parent, arrow) {
        ...
        setTimeout(function() {
          ...
          return $(".info-container").css("display", "none");
        }, timeout);
        if (sibling !== void 0 && !sibling.hasClass("is-open")) {
          ...
          return setTimeout(function() {
            ...
            return setTimeout(function() {
              ...
              return sibling.find(".info-background img").css("display", "block");
            }, 1);
          }, timeout);
        } else {
          albumOpen = false;
      ...
      displayAlbum = function(min, max, refreshSplash) {
        ...
        createAlbum = function(i) {
          ...
          albumTracks = [];
          albumLi = "<li> <div class='album-container' id='" + albumID + "'> <div class='album-text-container'> <div class='text-size-wrapper'> <h2>" + currentAlbum.title + "</h2> </div> <img src='" + currentAlbum.coverlink + "'> <div class='artist-year-container'> <p class='artist'>" + currentAlbum.romaji_artist + "</p> <p class='year'>" + currentAlbum.year + "</p> </div> </div> <div class='arrow-container'><ion-icon name='ios-arrow-down' class='album-arrow'></ion-icon></div> </div> <div class='info-container offset' id='" + albumID + "-info'> <div class='info-wrapper'> <div class='info-background'>" + "<img src='" + currentAlbum.coverlink + "'></div> <div class='info-text-container'> <div class='text-container'> <div class='title-container'> <h2>" + currentAlbum.title + "</h2> <h3><i>" + currentAlbum.romanization + "</i></h3> </div> <div class='artist-container'> <p>" + currentAlbum.romaji_artist + "</p> <p class='label'>" + currentAlbum.japanese_artist + "</p> </div> <div class='release-date'> <p class='label'>Release date:</p> <p>" + currentAlbum.year + "</p> </div> <div class='flavor'> <p class='label'>Flavor:</p> <p class='flavor-value'>" + currentAlbum.flavor + "</p> </div> <div class='description-container'> <p class='label'>Description:</p> <p class='description'>" + currentAlbum.description + "</p> </div> </div> <div class='track-grow-wrapper'> <div class='tracklist-wrapper'> <h3>Tracklist:</h3> <ul class='tracklist-container'> </ul> </div> <img class='expandable-img' src='" + currentAlbum.coverlink + "'> </div> </div> </div> </div> </li>";
          ...
          if ($(input).data("lastval") !== rawInput) {
            ...
            if (rawInput !== "") {
              doSearch = function(album) {
                var albumValues, j, len, matchValues, track, trackValues;
                albumValues = [album.title, album.romanization, album.romaji_artist, album.japanese_artist, album.year, album.description, album.flavor];
                trackValues = [];
                for (j = 0, len = tracks.length; j < len; j++) {
                  track = tracks[j];
